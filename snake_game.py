...
def pause_game():
    paused = True
    draw_text_center("Paused", YELLOW, HEIGHT // 2 - 20)
    draw_text_center("Press P to Resume", WHITE, HEIGHT // 2 + 20)
    pygame.display.update()
...
# check food  collision
    ...
    draw_text_center("Press ESC to exit" ,YELLOW ,HEIGHT//2 +40)
    pygame.display.update()
